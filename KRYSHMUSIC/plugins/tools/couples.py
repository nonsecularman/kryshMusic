...
from KRYSHMUSIC.mongo.couples_db import _get_image, get_couple
...
async def ctest(_, message):
    ...
    try:
        ...
        try:
            ...
            p1 = "KRYSHMUSIC/assets/upic.png"
        try:
            p2 = await app.download_media(photo2.big_file_id, file_name="pfp1.png")
        except Exception:
            p2 = "KRYSHMUSIC/assets/upic.png"
            
        img1 = Image.open(f"{p1}")
        img2 = Image.open(f"{p2}")

        img = Image.open("KRYSHMUSIC/assets/cppic.png")
