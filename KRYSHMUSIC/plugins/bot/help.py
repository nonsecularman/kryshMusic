...
from KRYSHMUSIC.utils import help_pannel
from KRYSHMUSIC.utils.database import get_lang
from KRYSHMUSIC.utils.decorators.language import LanguageStart, languageCB
from KRYSHMUSIC.utils.inline.help import help_back_markup, private_help_panel
from config import BANNED_USERS, START_IMG_URL, SUPPORT_CHAT
from strings import get_string, helpers
from KRYSHMUSIC.help.buttons import BUTTONS
from KRYSHMUSIC.help.helper import Helper
...
async def helper_cb(client, CallbackQuery):
    await CallbackQuery.edit_message_text(Helper.HELP_Miku, reply_markup=InlineKeyboardMarkup(BUTTONS.SBUTTON))
