...
from KRYSHMUSIC.utils.database import add_sudo, remove_sudo
from KRYSHMUSIC.utils.decorators.language import language
from KRYSHMUSIC.utils.extraction import extract_user
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        return await callback_query.answer("Bᴀᴅɴᴀᴍ ᴋᴀ 𝗟ᴜɴᴅ 𝗟ᴇɢᴀ 😂 \n 𝗦ᴜᴅᴏʟɪsᴛ 𝗗ᴇᴋʜɴᴇ ᴀᴀʏᴀ ᴍᴄ 🤧🖕", show_alert=True)
    else:
