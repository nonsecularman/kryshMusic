...
from KRYSHMUSIC.mongo.readable_time import get_readable_time
from KRYSHMUSIC.mongo.afkdb import add_afk, is_afk, remove_afk
import time
import re
...
@app.on_message(filters.command(["meera", "badnam", "kriti", "byo", "you"], prefixes=["a", "A", "b", "B", "/", "!", "."]))
