...
def format_promotion_message(chat_name, user_mention, admin_mention, action):
    action_text = "kriti promote" if action == " kriti promote" else "kriti ᴅᴇᴍᴏᴛɪɴɢ"
    return (
...
@app.on_message(filters.command("kriti promote"))
...
@app.on_message(filters.command("kriti demote kar do"))
@admin_required("can_promote_members")
