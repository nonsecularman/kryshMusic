...
async def get_thumb(videoid: str, player_username: str = None) -> str:
    ...
    try:
        title_font = ImageFont.truetype("KRYSHMUSIC/assets/f.ttf", 32)
        regular_font = ImageFont.truetype("KRYSHMUSIC/assets/font.ttf", 18)
        shreya_font = ImageFont.truetype("KRYSHMUSIC/assets/font.ttf", 26)
    except OSError:
    ...
    icons_path = "KRYSHMUSIC/assets/play_icons.png"
